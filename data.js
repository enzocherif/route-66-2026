...
// ---------------------------------------------------------------- JOUR 6
{
  ...
  title: "Antelope Canyon — marche & kayak",
  wake: "6h00", wakeType:"calc",
  wakeReason: "L'horaire précis dépendra du créneau que vous obtiendrez à la réservation (voir alerte) — visez le tout premier tour du matin (souvent autour de 8h) pour une lumière plus douce et moins de monde. Comptez 30-45 min pour être prêts et faire le check-in avant le départ du tour.",
  breakfast: { included:true, note:"Petit-déjeuner à l'Hôtel Page (nuit précédente)." },
  ...
  alert: { tone:"rust", title:"À RÉSERVER DE TOUTE URGENCE", text:"La marche guidée dans Antelope Canyon et le tour en kayak ne sont PAS encore réservés selon votre checklist. Les créneaux se remplissent vite (parfois complet plusieurs jours à l'avance en haute saison) — réservez cette semaine sur le site d'un tour-opérateur agréé (ex. antelopecanyon.com pour la marche, lakepowelladventure.com ou kayakpowell.com pour le kayak). Pensez aussi, si Angels Landing (jour 7) vous tente, à tenter la loterie \"day-before\" sur l'appli NPS/recreation.gov avant ~15h (heure Utah) aujourd'hui pour un permis valable demain." },
  timeline: [
    { type:"drive", label:"Page → Antelope Canyon", dur:"9 min", desc:"Très proche de votre hôtel de la veille.", link: gmaps("36°53'18.1\"N 111°27'22.0\"W"), linkText:"Ouvrir dans Maps" },
    { type:"hike", label:"Antelope Canyon — marche guidée", dur:"~1 h", desc:"Visite obligatoirement guidée (Lower ou Upper Antelope Canyon, à choisir selon dispo). Les tours partent toutes les 30-45 min.", link: null },
    { type:"hike", label:"Antelope Canyon — kayak sur Lake Powell", dur:"~4 h", desc:"Pagayez 2,5 miles jusqu'à l'entrée du canyon inaccessible autrement, puis courte marche dans le slot canyon. Départ du Antelope Point Launch Ramp — arrivez 30-45 min avant le départ pour le check-in.", link: gmaps("Antelope Point Launch Ramp Page AZ"), linkText:"Ouvrir dans Maps" },
    { type:"drive", label:"Antelope Creek → Kanab", dur:"1 h 12", desc:"", link: gmaps("37°4'47.2\"N 112°33'57.2\"W"), linkText:"Itinéraire Google Maps" },
    { type:"sleep", label:"Dodo — Kanab", dur:"", desc:"Réservé.", link:"https://www.booking.com/Share-bdMry3i", linkText:"Voir la réservation" }
  ],
  highlight: {
    name: "Antelope Canyon (marche + kayak)",
    difficulty: "easy", diffLabel: "Facile / modéré",
    distance: "Marche : quelques centaines de mètres · Kayak : 5 miles A/R (8 km)",
    duration: "1 h (marche) + 4 h (kayak, avec équipement fourni)",
    water: "Prévoir de l'eau et une gourde étanche — vous serez en plein soleil sur le lac une bonne partie du kayak.",
    gear: "Sandales/chaussures d'eau (pieds mouillés garantis), vêtements légers et rechange, crème solaire, chapeau qui tient bien (attache recommandée), sac étanche pour le téléphone/appareil photo (souvent fourni par le loueur).",
    reservation: "OBLIGATOIRE pour les deux activités, à réserver en ligne à l'avance — voir l'alerte ci-dessus.",
    tips: [
      "Meilleure lumière dans le canyon (rayons visibles) : autour de midi, mais les départs sont souvent attribués sans que vous puissiez choisir l'heure exacte.",
      "L'entrée de la zone de mise à l'eau à Glen Canyon National Recreation Area coûte environ 30 $/véhicule si vous n'avez pas le pass America the Beautiful — le pass couvre cette entrée.",
      "Les enfants de 6 à 12 ans doivent être en kayak double avec un adulte."
    ]
  }
},
// ---------------------------------------------------------------- JOUR 7
...
const RESERVATIONS = [
  ...
  { date:"10 sept.", label:"Antelope Canyon — marche guidée", link:"https://www.antelopecanyon.com/", done:false, price:"—", urgent:true },
  { date:"10 sept.", label:"Antelope Canyon — kayak", link:"https://www.lakepowelladventure.com/", done:false, price:"—", urgent:true },
